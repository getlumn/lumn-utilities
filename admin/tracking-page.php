...
function lumn_ut_render_tracking_intro() {
    ...
    echo '<p>' . esc_html__('Phone, email, appointment, and directions click tracking; the explicit data-lumn-event markup mechanism; and form submission tracking for Gravity Forms and Formidable Forms are all implemented and available below. Downloads, video, and external-link tracking are not implemented yet - their toggles exist now so no further setup will be needed once they ship.', 'lumn-utilities') . '</p>';
