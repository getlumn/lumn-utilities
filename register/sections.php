...
function lumn_ut_register_utilities_sections() {
    ...
    function lumn_ut_practice_info_section_callback() {
        ...
        echo '<div class="lumn-utilities-admin-accordion-header"><span class="icon-title">How to Use</span><span class="plus">+</span><span class="minus">-</span></div>';
...
add_action('admin_init', 'Lumn\Utilities\lumn_ut_register_utilities_sections');