...
function lumn_ut_2_site_name_shortcode( $atts = '' ) {
    ...
    if ($value['html_tag'] && lumn_ut_2_check_html_tag_value($value['html_tag'])) {
        return '<' . $value['html_tag'] . '>' . $lumn_site_name . '</' . $value['html_tag'] . '>';
    } else {
        return $lumn_site_name;
    }
}
add_shortcode('lumn_site_name', 'Lumn\Utilities2\lumn_ut_2_site_name_shortcode');

// Define the [lumn_call] shortcode
function lumn_ut_2_call_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_call', 'Lumn\Utilities2\lumn_ut_2_call_shortcode');

// Define the [lumn_txt] shortcode
function lumn_ut_2_txt_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_txt', 'Lumn\Utilities2\lumn_ut_2_txt_shortcode');

// Define the [lumn_fax] shortcode
function lumn_ut_2_fax_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_fax', 'Lumn\Utilities2\lumn_ut_2_fax_shortcode');

// Define the [lumn_email] shortcode
function lumn_ut_2_email_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_email', 'Lumn\Utilities2\lumn_ut_2_email_shortcode');

// Define the [lumn_address] shortcode
function lumn_ut_2_address_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
...
add_shortcode('lumn_address', 'Lumn\Utilities2\lumn_ut_2_address_shortcode');

// Define the [lumn_address_street] shortcode
function lumn_ut_2_address_street_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_address_street', 'Lumn\Utilities2\lumn_ut_2_address_street_shortcode');

// Define the [lumn_address_street2] shortcode
function lumn_ut_2_address_street2_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_address_street2', 'Lumn\Utilities2\lumn_ut_2_address_street2_shortcode');

// Define the [lumn_address_city] shortcode
function lumn_ut_2_address_city_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_address_city', 'Lumn\Utilities2\lumn_ut_2_address_city_shortcode');

// Define the [lumn_address_state] shortcode
function lumn_ut_2_address_state_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_address_state', 'Lumn\Utilities2\lumn_ut_2_address_state_shortcode');

// Define the [lumn_address_zip] shortcode
function lumn_ut_2_address_zip_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_address_zip', 'Lumn\Utilities2\lumn_ut_2_address_zip_shortcode');

// Define the [lumn_map] shortcode
function lumn_ut_2_map_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_map', 'Lumn\Utilities2\lumn_ut_2_map_shortcode');

// Define the [lumn_hours] shortcode
function lumn_ut_2_hours_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
...
add_shortcode('lumn_hours', 'Lumn\Utilities2\lumn_ut_2_hours_shortcode');
...
function lumn_ut_2_social_url_shortcode( $atts = '' ) {
	$value = shortcode_atts( array(
        'name' => ''
    ), $atts );
...
add_shortcode('lumn_social_url', 'Lumn\Utilities2\lumn_ut_2_social_url_shortcode');

// Define the [lumn_svg] shortcode
function lumn_ut_2_icons_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'name' => '',
        'src' => ''
    ), $atts );
    ...
    if ( $value['src'] ) {
        ...
        $svg_path = '/svgs/';
        $svg_file = LUMN_UTILITIES_2_PLUGIN_PATH . $svg_path . $value['name'] . '.svg';
...
add_shortcode( 'lumn_svg', 'Lumn\Utilities2\lumn_ut_2_icons_shortcode' );

// Define the [lumn_copyright] shortcode
function lumn_ut_2_copyright_shortcode( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
    ...
    $content = $lumn_site_name . ' &copy; ' . $year . ' | Propelled by <a href="https://getlumn.com/" target="_blank" rel="noopener">LUMN ' . lumn_ut_2_icons_shortcode(array('name' => 'lumn-fish')) . '</a>';
...
add_shortcode( 'lumn_copyright', 'Lumn\Utilities2\lumn_ut_2_copyright_shortcode' );

// Define the [lumn_year] shortcode
function lumn_ut_2_current_year( $atts = '' ) {
    $value = shortcode_atts( array(
        'html_tag' => '' // Wrap in an HTML tag
    ), $atts );
...
add_shortcode('lumn_year', 'Lumn\Utilities2\lumn_ut_2_current_year');